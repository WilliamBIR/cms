	...
	for(i=0;i<6;i++){
		if(productos.hoja[i].producto!=""){
			...
			if(productos.hoja[i].centavo!=""){
				document.getElementById("centavo"+(i+1)).style.display = "flex";
				document.getElementById("centavo"+(i+1)).innerHTML = '.'+productos.hoja[i].centavo;
			}
			else
				document.getElementById("centavo"+(i+1)).style.display = "none";
...
function checarLista(){
	console.log('Aplicacion de Panecillos');
